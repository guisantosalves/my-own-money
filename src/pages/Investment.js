  ...
  return (
    <div className="investment">
      <div className="investment__left">
        <div className="investment__graphs">
          <div className="investment__leftGraphOne">
            <Bar options={options} data={dataChart} />
          </div>
          <div className="investment__notes">
            {notes.map((item, index)=>(
              <div className="investment__note">

                <div className="investment__noteClose">
                  <IconButton onClick={(e)=>deletingNote(item)}>
                    <Close fontSize="small"/>
                  </IconButton>
                </div>
                <h1>{item.data.title}</h1>
                <div className="investment__noteText">
                  <p>{item.data.note}</p>
                </div>

              </div>
            ))}
            <div className="investment__noteAdd">
      ...
      <div className="investment__right">
        <div className="investment__rightListOfThings">
          {data.map((item, index) => (
            <Row
              key={item.id}
              id={item.id}
            ...
            <div className="modal__form">
              ...
              <div className="modal__note">
                <input 
                  ...
                  placeholder="Ex: I need to buy more investment"
                />
              </div>
            </div>
