...
function Other() {
  ...
  return (
    <div className="other">
      <div className="other__left">
        <div className="other__graphs">
          <div className="other__leftGraphOne">
            <Bar options={options} data={dataChart} />
          </div>
          <div className="other__notes">
            {notes.map((item, index)=>(
              <div className="other__note">

                <div className="other__noteClose">
                  <IconButton onClick={(e)=>deletingNote(item)}>
                    <Close fontSize="small"/>
                  </IconButton>
                </div>
                <h1>{item.data.title}</h1>
                <div className="other__noteText">
                  <p>{item.data.note}</p>
                </div>

              </div>
            ))}
            <div className="other__noteAdd">
      ...
      <div className="other__right">
        <div className="other__rightListOfThings">
          {data.map((item, index) => (
            <Row
              key={item.id}
              id={item.id}
            ...
            <div className="modal__form">
              ...
              <div className="modal__note">
                <input 
                  ...
                  placeholder="Ex: I need to buy more other"
                />
              </div>
            </div>
