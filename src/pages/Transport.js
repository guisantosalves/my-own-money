  ...
  return (
    <div className="transport">
      <div className="transport__left">
        <div className="transport__graphs">
          <div className="transport__leftGraphOne">
            <Bar options={options} data={dataChart} />
          </div>
          <div className="transport__notes">
            {notes.map((item, index)=>(
              <div className="transport__note">

                <div className="transport__noteClose">
                  <IconButton onClick={(e)=>deletingNote(item)}>
                    <Close fontSize="small"/>
                  </IconButton>
                </div>
                <h1>{item.data.title}</h1>
                <div className="transport__noteText">
                  <p>{item.data.note}</p>
                </div>

              </div>
            ))}
            <div className="transport__noteAdd">
      ...
      <div className="transport__right">
        <div className="transport__rightListOfThings">
          {data.map((item, index) => (
            <Row
              key={item.id}
              id={item.id}
            ...
            <div className="modal__form">
              ...
              <div className="modal__note">
                <input 
                  ...
                  placeholder="Ex: I need to buy more transport"
                />
              </div>
            </div>
